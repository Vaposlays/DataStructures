...
//  DataStructures
//
//  Created by Childers, Mason on 2/26/18.
...
template <class Type>
void CircularNode<Type> :: add(Type item)
{
...
template <class Type>
void CiruclarList<Type> :: addAtIndex(int index, Type item)
{
    assert (index >= 0 && index <= this->size);
    ...
    addMe = new DoubleNode<Type>(item, previous, next);
